...
class APInvoiceheaderrequest:
    ...
    def __init__(self,obj_invhdr):
        ...
        if 'ecfheader_id' in obj_invhdr:
            self.apheader_id=obj_invhdr['ecfheader_id']
        ...
        if 'supplier_id' in obj_invhdr:
            if obj_invhdr['supplier_id'] is not None:
                if 'id' in obj_invhdr['supplier_id']:
                    self.supplier_id = obj_invhdr['supplier_id']['id']
        if 'supplierstate_id' in obj_invhdr:
            if obj_invhdr['supplierstate_id'] is not None:
                if 'id' in obj_invhdr['supplierstate_id']:
                    self.supplierstate=obj_invhdr['supplierstate_id']['id']
        if 'inv_crno' in obj_invhdr:
                self.invoicehdr_crno = obj_invhdr['inv_crno']

    def get_id(self):
        return self.id
    def get_apheader_id(self):
        return self.apheader_id
    ...
    def get_invoicehdr_crno(self):
        return self.invoicehdr_crno